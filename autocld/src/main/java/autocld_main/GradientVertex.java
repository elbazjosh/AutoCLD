 ...
 */
public class GradientVertex<V,E> implements Renderer.Vertex<V,E> {
    ...
    public GradientVertex(Color colorOne, Color colorTwo, boolean cyclic) {
	...
	public GradientVertex(Color colorOne, Color colorTwo, Color pickedColorOne, Color pickedColorTwo, PickedState<V> pickedState, boolean cyclic) {
		this.colorOne = colorOne;
		this.colorTwo = colorTwo;
	...
	public void paintVertex(RenderContext<V,E> rc, Layout<V,E> layout, V v) {
        ...
        if (rc.getVertexIncludePredicate().apply(Context.<Graph<V,E>,V>getInstance(graph,v))) {
            ...
            // get the shape to be rendewhite
